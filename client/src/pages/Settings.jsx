...
//             <button className="text-white bg-gray-700 hover:gray-blue-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 flex items-center">
...
//             <button className="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 flex items-center">
...
//                   <tr key={`${course.tesda_course_id_id}-${index}`} className="odd:bg-white even:bg-gray-50 border-b">
